(function () {
    ...
    function play(element) {
      ...
      if (element.json) {
        ...
        Api.qualitys(element.video, function (qualitys) {
          Lampa.Loading.stop();
    ...
    function Sisi(object) {
      ...
      comp.onMore = function (data) {
        Lampa.Activity.push({
          url: data.url,
          title: data.title,
          component: 'sisi_view_' + Defined.api,
          page: 2
        });
      };
    ...
    function startPlugin() {
      ...
      Lampa.Component.add('sisi_' + Defined.api, Sisi);
      Lampa.Component.add('sisi_view_' + Defined.api, View); //Lampa.Search.addSource(Search)
      ...
      function addFilter() {
        ...
        Lampa.Listener.follow('activity', function (e) {
          ...
          timer = setTimeout(function () {
            if (activi) {
              if (activi.component !== 'sisi_view_' + Defined.api) {
                button.hide();
                activi = false;
              }
            }
          ...
          if (e.type == 'start' && e.component == 'sisi_view_' + Defined.api) {
            button.show();
            activi = e.object;
          }
        });
